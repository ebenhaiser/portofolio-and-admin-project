            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="message-box">                        
                        ...
                        <?php if(!empty($rowAbout['cv'])) : ?>
                            <a href="admin/cv_directory/<?php echo $rowAbout['cv'] ?>" class="sim-btn btn-hover-new" data-text="Download CV"><span>Download CV</span></a>
                        <?php endif ?>
                    </div><!-- end messagebox -->
                </div><!-- end col -->
                ...
                <div class="col-md-6">
                    ...
                    <div class="right-box-pro wow fadeIn">
                        <img src="admin/img/aboutPicture/<?php echo $rowAbout['picture'] ?>" alt="Profil Picture" class="img-fluid img-rounded">
                    </div><!-- end media -->
                    <?php endif ?>
                </div><!-- end col -->
            </div><!-- end row -->
