<?php
    ...
    if(isset($_POST['save'])) {
        ...
        $aboutSummary = $_POST['aboutSummary'];
        ...
        if (mysqli_num_rows($queryAboutEditor) > 0) {
            ...
            if (!empty($_FILES['picture']['name'])) {
                ...
                $update = mysqli_query($connection, "UPDATE website_profile SET title='$aboutName', subtitle='$aboutSummary' WHERE id ='$aboutUserID'");
            };
        } else {
            // insert query
            if (!empty($_FILES['picture']['name'])) {
                ...
                $insert = mysqli_query($connection, "INSERT INTO website_profile (title, subtitle) VALUES ('$aboutName','$aboutSummary')");
            };
        };
    };
?>
